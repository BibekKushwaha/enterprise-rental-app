            ...
            <div className='flex items-center gap-4 md:gap-6'>
                ...
                </Link>
                {
                    isDashboardPage && authUser && (
                        ...
                        onClick={()=>router.push(authUser.userRole?.toLocaleLowerCase()=== "manager" ? "/managers/newproperty" : "/search")}
                        >
                            {
                                authUser.userRole?.toLocaleLowerCase() === "manager" ? (
                                    <>
                ...
                isAuthLoading ? (
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuSeparator className='bg-primary-200'/>
                         <DropdownMenuItem className='cursor-pointer hover:!bg-primary-700 hover:!text-primary-100 text-bold'
                        onClick={()=>router.push(
                            `${authUser.userRole?.toLocaleLowerCase()}s/settings`,
                    ...
                    <> <Link href="/signin">
                        <Button variant="outline" className='text-white border-white bg-transparent hover:bg-white hover:text-primary-700 rounded-xl'>
                            Sign In
                        </Button>
                        </Link>
                        <Link href="/signup">
                        <Button variant="secondary" className='text-white  bg-secondary-600 hover:bg-white hover:text-primary-700 rounded-xl'>
                            Sign Up
                        </Button>
                        </Link>
                    </>
