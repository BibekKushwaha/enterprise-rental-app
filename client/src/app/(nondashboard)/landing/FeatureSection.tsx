...
const FeatureSection = () => {
  return (
    ...
    className='pt-24 pb-8 px-6 sm:px-8 lg:px-12 xl:px-16 bg-white'
    >
        <div className='max-w-4xl xl:max-w-6xl mx-auto'>
            <motion.h2
            variants={itemVariants}
            className='text-3xl font-bold text-center mb-10 w-full sm:w-2/3 mx-auto'>
                ...
                [0,1,2].map((index)=>(
                    <motion.div
                        ...
                        variants={itemVariants}>
                            ...
                            "Find trustorthy rental listings with ease using our advanced search filters and verified properties.",
                            ][index]
                            }
